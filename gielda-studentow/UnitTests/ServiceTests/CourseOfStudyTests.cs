...
{
    [TestClass]
    public class CourseOfStudyTests
    {
        private Mock<IStudentExchangeDataContext> _mockStudentExchangeDataContext;
        private ICourseOfStudyService _courseOfStudyService;
        ...
        private void InitializeFields()
        {
            ...
            _courseOfStudyService = new CourseOfStudyService(_mockStudentExchangeDataContext.Object);
        }
