...
namespace UnitTests.ServiceTests
{
    ...
    public class StudentServiceTests
    {
        ...
        private void InitializeFields()
        {
            ...
            _studentService = new StudentService(_mockStudentExchangeDataContext.Object);
        }
        ...
        public void TestGetStudentById()
        {
            ...
            //mockUsersSet.Setup(x => x.OfType<Student>()).Returns(mockUsersSet.Object.Cast<Student>());
            ...
            var result = _studentService.GetStudentById("testId");
            Assert.AreSame(_studentList.ToList().Find(s => s.Id == "testId"), result);
        }
        ...
        public void TestGetStudentGroups()
        {
            ...
            var result = _studentService.GetStudentGroups("testId");
            Assert.IsTrue(result.Intersect(_groupSet.ToList()).Count() == result.Count);
        }
