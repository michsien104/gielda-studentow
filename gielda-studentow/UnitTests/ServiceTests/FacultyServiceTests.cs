...
namespace UnitTests.ServiceTests
{
    ...
    public class FacultyServiceTests
    {
        ...
        [TestMethod]
        public void TestGetCourseFaculty()
        {
        ...
        public void TestGetFacultyCourses()
        {
            ...
            var result = _facultyService.GetFacultyCourses(1L);
            Assert.IsTrue(_facultySet.ToList().Find(f => f.Id == 1L).CoursesOfStudy.Intersect(result).Count() == result.Count);
        }
