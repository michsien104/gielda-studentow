...
namespace UnitTests.ServiceTests
{
    ...
    public class TutorServiceTests
    {
        ...
        public void TestGetTutorById()
        {
            ...
            var result = _tutorService.GeTutorById("testId2");
            Assert.AreSame(_userSet.ToList().Find(u => u.Id == "testId2"), result);
        }
        ...
        [TestMethod]
        public void TestAddTutorCourse_NotAddedBecauseAlreadyHasThisCourse()
        {
            var mockUserSet = CreateMockUserSet();
            mockUserSet.SetReturnsDefault(mockUserSet.Object.Cast<Tutor>());
            _mockStudentExchangeDataContext.Setup(c => c.Users).Returns(mockUserSet.Object);
            ...
            _mockStudentExchangeDataContext.Setup(c => c.CoursesOfStudy).Returns(mockCoursesSet.Object);
            _mockStudentExchangeDataContext.Setup(c => c.SaveChanges());
            _tutorService.AddTutorCourse("testId2", 1L);
            _mockStudentExchangeDataContext.Verify(c => c.SaveChanges(), Times.Never);
        }

        [TestMethod]
        public void TestGetTutorCourses_TutorDoesNotExist()
        {
            var mockUserSet = CreateMockUserSet();
            mockUserSet.SetReturnsDefault(mockUserSet.Object.Cast<Tutor>());
            _mockStudentExchangeDataContext.Setup(c => c.Users).Returns(mockUserSet.Object);
            var result = _tutorService.GetCourses("testId");
            Assert.AreEqual(result.Count, 0);
        }

        [TestMethod]
        public void TestGetTutorCourses_TutorDoesExist()
        {
            var mockUserSet = CreateMockUserSet();
            mockUserSet.SetReturnsDefault(mockUserSet.Object.Cast<Tutor>());
            _mockStudentExchangeDataContext.Setup(c => c.Users).Returns(mockUserSet.Object);
            var result = _tutorService.GetCourses("testId2");
