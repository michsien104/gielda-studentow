...
namespace UnitTests.ServiceTests
{
    ...
    public class AuthenticationServiceTests
    {
        ...
        private IAuthenticatonService _authenticatonService;
        ...
        public void TestGetUserIdByUsername()
        {
            ...
            var result = _authenticatonService.GetUserIdByUsername("akowalski");
            Assert.AreSame(_userSet.ToList().Find(u => u.UserName == "akowalski").Id, result);
        }
    }
}
